...
.weather-container { background: #fff; padding: 20px; border-radius: 10px;
box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1); display: inline-block;
}
...
<p id="localtime">Local Time: <?php echo $weatherData['location']['localtime'];
?></p>
